...
const TimelineElements = [
    {
      ...
      },
      {
        ...
        description:
          "Developed a SquareSpace prototype for the HealthyCUNY website, using coding injections with HTML and CSS properties..",
        icon: "/images/cunyimg.png",
      },
      {
        id: 5,
        title: "HealthyCUNY Advocacy Intern",
        description:
          "Collaborated with HealthyCUNY under the CUNY Research Foundation to advocate for food insecure students and marginalized individuals, bridging connections to vital resources at school, state, and federal levels.",
        icon: "/images/cunyimg.png",
      },
    ];
